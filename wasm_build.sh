...
if [ ! -d "./build_wasm" ]; then
    ...
    meson -Db_lto=true -Ddefault_library=static -Dstatic=true -Dloaders="all" -Dsavers="all" -Dthreads=false -Dengines="wg_beta" -Dbindings="wasm_beta" --cross-file /tmp/.wasm_cross.txt build_wasm
fi
